...
const WhatsAppButton = ({  message = "Hello! I'd like to chat with you." }) => {
  // Format the phone number by removing any non-digit characters
  const phoneNumber = "+918123096298"; // Replace with your phone number
  ...
  return (
    <div className="fixed left-4 bottom-4 z-50">
      <a
        ...
        className="flex items-center justify-center w-14 h-14 bg-green-500 rounded-full shadow-lg hover:bg-green-600 transition-all duration-300 group"
